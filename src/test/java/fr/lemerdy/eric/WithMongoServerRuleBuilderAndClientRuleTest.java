...
public class WithMongoServerRuleBuilderAndClientRuleTest {
    ...
    @Rule
    public MongoClientRule mongodb = new MongoClientRule();

    @Test
    public void should_connect_to_the_test_database() throws Exception {
        assertThat(mongodb.getMongo().getDB("test").getCollectionNames()).isNotNull();
    }
}
